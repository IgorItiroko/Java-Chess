...
public class Tabuleiro{
	...
	/// Construtor que inicializa o tabuleiro resetado.
	public Tabuleiro()
	{
		this.resetTabuleiro();
	}
	
	/// recebe as coordenadas e devolve como Quadrado.
	...
	/// função que imprime o tabuleiro no console, usada nos testes.
	...
	public void resetTabuleiro()
	{
		...
		campo[1][0] = new Quadrado(1, 0, new Peão(true,1,true));
		campo[1][1] = new Quadrado(1, 1, new Peão(true,1,true));
		campo[1][2] = new Quadrado(1, 2, new Peão(true,1,true));
		campo[1][3] = new Quadrado(1, 3, new Peão(true,1,true));
		campo[1][4] = new Quadrado(1, 4, new Peão(true,1,true));
		campo[1][5] = new Quadrado(1, 5, new Peão(true,1,true));
		campo[1][6] = new Quadrado(1, 6, new Peão(true,1,true));
		campo[1][7] = new Quadrado(1, 7, new Peão(true,1,true));
		...
		campo[6][0] = new Quadrado(6, 0, new Peão(false,1,true));
		campo[6][1] = new Quadrado(6, 1, new Peão(false,1,true));
		campo[6][2] = new Quadrado(6, 2, new Peão(false,1,true));
		campo[6][3] = new Quadrado(6, 3, new Peão(false,1,true));
		campo[6][4] = new Quadrado(6, 4, new Peão(false,1,true));
		campo[6][5] = new Quadrado(6, 5, new Peão(false,1,true));
		campo[6][6] = new Quadrado(6, 6, new Peão(false,1,true));
		campo[6][7] = new Quadrado(6, 7, new Peão(false,1,true));
		for (int i = 2; i < 6; i++)
		{
			for (int j = 0; j < 8; j++)
			{
